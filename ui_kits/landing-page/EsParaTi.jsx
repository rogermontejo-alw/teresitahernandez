...
function EsParaTi() {
  ...
  return (
    <section data-screen-label="03 · Es Para Ti" style={{background:"var(--surface-sunken)",padding:"96px 32px"}}>
      <div style={{maxWidth:"var(--container-max)",margin:"0 auto",textAlign:"center"}}>
        ...
        <div className="esparati-grid" style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:20,textAlign:"left"}}>
          {items.map((text) => (
            <div key={text} style={{display:"flex",gap:14,alignItems:"flex-start",background:"var(--white)",borderRadius:"var(--radius-lg)",padding:"24px 28px",boxShadow:"var(--shadow-sm)"}}>
